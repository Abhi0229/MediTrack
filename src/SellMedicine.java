...
public class SellMedicine extends javax.swing.JFrame {
    ...
    private void medicineName(String nameOrUnqiueId) {
        DefaultTableModel model = (DefaultTableModel) medicines.getModel();
        model.setRowCount(0);
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("select *from medicine where name like '" +nameOrUnqiueId+ "%' or uniqueId like '" + nameOrUnqiueId + "%'");
            while(rs.next()){
    ...
    public String getUnqiueId(String prefix){
    ...
    private void initComponents() {
        ...
        lblFinalTotalAmount = new javax.swing.JLabel();
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(521, 28, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1305, 28, -1, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setText("Search");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(223, 147, -1, -1));
        ...
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(94, 181, 300, -1));

        medicines.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jScrollPane1.setViewportView(medicines);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(94, 221, 300, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel3.setText("Medicine ID");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 147, -1, -1));

        txtUniqueId.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        getContentPane().add(txtUniqueId, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 181, 300, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel4.setText("Name");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 233, -1, -1));

        txtName.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 267, 300, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel5.setText("Company Name");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 327, -1, -1));

        txtCompanyName.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        getContentPane().add(txtCompanyName, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 361, 300, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel6.setText("Price Per Unit");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(972, 147, -1, -1));
        ...
        getContentPane().add(txtPricePerUnit, new org.netbeans.lib.awtextra.AbsoluteConstraints(972, 181, 300, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel7.setText("No. Of Units");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(972, 233, 70, -1));
        ...
        getContentPane().add(txtNoOfUnits, new org.netbeans.lib.awtextra.AbsoluteConstraints(972, 267, 300, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel8.setText("Total Amount");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(972, 327, -1, -1));

        txtTotalPrice.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        getContentPane().add(txtTotalPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(972, 361, 300, -1));
        ...
        cartTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medicine ID", "Name", "Company Name", "Price per Unit", "Qty", "Total Amount"
            }
        ));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 447, 676, 202));
        ...
        getContentPane().add(btnAddToCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(845, 402, -1, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel9.setText("RS:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(719, 667, -1, -1));

        lblFinalTotalAmount.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        lblFinalTotalAmount.setText("00");
        getContentPane().add(lblFinalTotalAmount, new org.netbeans.lib.awtextra.AbsoluteConstraints(761, 667, -1, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1027, 675, -1, -1));
        ...
        if (checkStock == 1) {
            ...
            if (cartTable.getRowCount() != 0) {
                for (int i = 0; i < cartTable.getRowCount(); i++) {
                    ...
                    //Object valueAt = dtm.getValueAt(i, 0);
                    //if (valueAt != null && Integer.parseInt(valueAt.toString()) == Integer.parseInt(uniqueId)) {
            ...
            if (checkMedicineAlreadyExistInCart == 0) {
                ...
                lblFinalTotalAmount.setText(String.valueOf(finalTotalPrice));
    ...
    private void medicinesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_medicinesMouseClicked
        // TODO add your handling code here:
        int index=medicines.getSelectedRow();
        TableModel model=medicines.getModel();
   ...
   //if (index != -1) { // Ensure a row is selected
        ...
        if (a == 0) {
            ...
            Object totalValue = model.getValueAt(index, 5).toString(); // Total Amount column
            if (totalValue != null) { // Check if the value is not null
                String total = totalValue.toString();
                finalTotalPrice = finalTotalPrice - Integer.parseInt(total);
                lblFinalTotalAmount.setText(String.valueOf(finalTotalPrice));
                ((DefaultTableModel) cartTable.getModel()).removeRow(index);
            } else {
                JOptionPane.showMessageDialog(null, "Total Amount is null. Cannot remove this medicine.");
            }
        }
    //}
    ...
    try {
        ...
        /*Object qtyValue = dtm.getValueAt(i, 4); // Qty column
        if (qtyValue != null) {
            int qty = Integer.parseInt(qtyValue.toString());
            //st.executeUpdate("update medicine set quantity=quantity-" + qty + " where uniqueId=" + Integer.parseInt(dtm.getValueAt(i, 0).toString()));
        }*/
    } catch (Exception e) {
        JOptionPane.showMessageDialog(null, e);
    }
             ...
             try {
    SimpleDateFormat myFormat = new SimpleDateFormat("dd-MM-yyyy"); // Corrected date format
    Calendar cal = Calendar.getInstance();
    Connection con = ConnectionProvider.getCon();
    PreparedStatement ps = con.prepareStatement("insert into bill(billId,billDate,totalPaid,generatedBY) values(?,?,?,?)");
    ps.setString(1, billId); // Set the first parameter
    ...
    JOptionPane.showMessageDialog(null, e);
             ...
             try{
                 ...
                 doc.open();
                 Paragraph pharmacyName = new Paragraph("                                       MediTrack\n");
    ...
    private javax.swing.JLabel lblFinalTotalAmount;
